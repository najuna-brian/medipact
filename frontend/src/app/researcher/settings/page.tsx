    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-0 md:ml-64">
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            <h1 className="mb-2 text-3xl font-bold">Researcher Settings</h1>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="rounded-lg border p-4">
                  ...
                  <p className="mt-1 font-mono text-xs text-muted-foreground">0.0.123456</p>
                </div>
                <div className="rounded-lg border p-4">
                  <div className="mb-2 flex items-center justify-between">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">≈ $25.00 USD per month</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                  <p className="mb-1 font-semibold text-green-900">IRB Approval</p>
                  <p className="text-sm text-green-800">Status: Approved</p>
                  <p className="mt-1 text-xs text-green-700">Expires: Dec 31, 2024</p>
                </div>
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  <p className="mb-1 font-semibold text-blue-900">Data Use Agreement</p>
