    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-4 md:py-8">
        <div className="mb-6 md:mb-8">
          <h1 className="mb-2 text-2xl font-bold md:text-3xl">Researcher Verification Management</h1>
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    {researcherDetail.contactName && (
                      <p>
                        <span className="font-medium">Contact Name:</span> {researcherDetail.contactName}
                      </p>
                    )}
                    ...
                    {researcherDetail.hederaAccountId && (
                      <p>
                        <span className="font-medium">Hedera Account:</span> {researcherDetail.hederaAccountId}
                      </p>
                    )}
                    <p>
                      <span className="font-medium">Access Level:</span> {researcherDetail.accessLevel || 'basic'}
                    </p>
                    <p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      {typeof researcherDetail.verificationDocuments === 'object' ? (
                        Object.entries(researcherDetail.verificationDocuments).map(([key, value]) => (
                          <div key={key}>
                        ...
                        <div>{renderDocument(String(researcherDetail.verificationDocuments))}</div>
                      )}
                    </div>
                  </div>
                ) : (
        ...
        <AlertDialog open={showApproveDialog} onOpenChange={setShowApproveDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Confirm approval of this researcher&apos;s verification. The researcher will be notified
                and will be able to purchase datasets and access the marketplace.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <div className="space-y-4">
              <div>
