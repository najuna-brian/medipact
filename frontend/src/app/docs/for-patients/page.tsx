    ...
    <div className="space-y-8">
      <div className="border-b border-gray-200 pb-8">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Learn how to use MediPact to store your medical records, control your data, and earn money
          when researchers use your anonymized data.
        </p>
      </div>
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-gray-200 bg-white p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6 text-gray-700">
            <li>
              <strong>Secure Storage:</strong> Store all your medical records in one place,
              accessible from anywhere
            </li>
            <li>
              <strong>Complete Control:</strong> You decide who can access your data and for what
              purpose
            </li>
            <li>
              <strong>Fair Compensation:</strong> Earn money (60% of revenue) when researchers use
              your anonymized data
            </li>
            <li>
              <strong>Privacy Protection:</strong> Your data is anonymized using advanced techniques
              before being shared
            </li>
            <li>
              <strong>Cross-Hospital Access:</strong> Connect multiple hospitals to see your
    ...
    style L fill:#BBDEFB,stroke:#1976D2,stroke-width:2px`}
        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="mt-2 text-gray-700">
              Create your MediPact account by providing basic information. You'll receive a unique
              Patient ID (UPI) that links all your medical records across hospitals.
            </p>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            <h3 className="text-lg font-semibold text-gray-900">
              Step 3: Set Data Sharing Preferences
            </h3>
            <p className="mt-2 text-gray-700">Control how your data is shared with researchers:</p>
            <ul className="mt-2 list-disc space-y-1 pl-6 text-sm text-gray-600">
              <li>
                <strong>Global Opt-In/Opt-Out:</strong> Enable or disable all data sharing
              </li>
              <li>
                <strong>Researcher Approvals:</strong> Approve or decline individual researcher
                requests
              </li>
              <li>
                <strong>Granular Controls:</strong> Control which types of data can be shared
              </li>
            </ul>
          </div>
        </div>
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border-2 border-green-500 bg-green-50 p-6">
          ...
          <p className="mt-2 text-gray-700">
            When a researcher purchases a dataset containing your anonymized data, you automatically
            receive <strong>60% of your share</strong> of the payment.
          </p>
          <div className="mt-4 rounded-lg border border-green-200 bg-white p-4">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-6 text-sm text-gray-700">
              ...
              <li>
                Your share: $10 × 60% = <strong>$6</strong>
              </li>
      ...
      <section>
        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-6">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-6 text-sm text-gray-700">
              <li>
                <strong>Stage 1:</strong> Removes names, addresses, phone numbers, exact dates of
                birth
              </li>
              <li>
                <strong>Stage 2:</strong> Further generalizes age ranges and dates
              </li>
              <li>
                <strong>K-Anonymity:</strong> Ensures at least 5 patients share the same demographic
                profile
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-lg border border-green-200 bg-green-50 p-6">
            ...
            <p className="mt-2 text-gray-700">Researchers can only access your data if:</p>
            <ul className="mt-2 list-disc space-y-1 pl-6 text-sm text-gray-700">
          ...
          <div className="rounded-lg border border-purple-200 bg-purple-50 p-6">
            ...
            <p className="mt-2 text-gray-700">
              All consent decisions are recorded on Hedera blockchain, creating an unchangeable
              audit trail. You can verify your consent status at any time.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-gray-200 bg-white p-6">
          ...
          <p className="mt-2 text-gray-700">
            When you register with MediPact, a Hedera wallet is automatically created for you. You
            never need to manage private keys or complex wallet software. Your account is ready to
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
              ...
              <p className="mt-1 text-sm text-gray-700">
                Check your earnings in USD (primary) and HBAR. All balances update automatically
                when researchers purchase your data.
              </p>
            </div>
            <div className="rounded-lg border border-green-200 bg-green-50 p-4">
              <h4 className="font-semibold text-gray-900">Withdraw Funds</h4>
              <p className="mt-1 text-sm text-gray-700">
                Withdraw to your bank account or mobile money provider (MTN, Airtel, etc.). Set
                automatic withdrawals when your balance reaches a threshold.
              </p>
            </div>
          </div>
        </div>
      ...
      <section>
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-green-200 bg-green-50 p-4">
            ...
            <p className="mt-1 text-sm text-gray-700">
              Get paid 60% of revenue when your anonymized data is used for research that advances
              medical science.
            </p>
          </div>
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <p className="mt-1 text-sm text-gray-700">
              Your data is anonymized using advanced techniques. Researchers never see your
              identity.
            </p>
          </div>
          <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
            ...
            <p className="mt-1 text-sm text-gray-700">
              You decide who can access your data. Approve or decline researcher requests
              individually.
            </p>
          </div>
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-gray-200 bg-white p-6">
          <p className="text-gray-700">Need help? Check out these resources:</p>
          <ul className="mt-3 list-disc space-y-2 pl-6 text-gray-700">
            <li>
              <Link href="/docs/wallet" className="text-[#00A9CE] hover:underline">
                Wallet & Payments Guide
              </Link>
            </li>
            <li>
              <Link href="/docs/patient-controls" className="text-[#00A9CE] hover:underline">
                Data Sharing Controls
              </Link>
            </li>
            <li>
              <Link href="/docs/privacy" className="text-[#00A9CE] hover:underline">
                Privacy & Security
              </Link>
            </li>
            <li>
              <Link href="/contact" className="text-[#00A9CE] hover:underline">
                Contact Support
              </Link>
            </li>
          </ul>
