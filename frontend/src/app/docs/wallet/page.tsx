  ...
  return (
    <div className="space-y-8">
      <div className="border-b border-gray-200 pb-8">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Seamless payment and withdrawal system with automatic Hedera account management. Users
          never need to worry about wallets or HBAR complexity.
        </p>
      </div>
      ...
      <section>
        ...
        <p className="mt-4 text-gray-700">
          MediPact's payment system is designed to be <strong>completely user-friendly</strong>.
          Users (patients and hospitals) receive payments automatically in their Hedera wallets,
          which are created and managed by the platform. All balances are displayed in USD (with
          HBAR shown below), and withdrawals can be sent directly to bank accounts or mobile money.
        </p>
        <div className="mt-4 rounded-lg border border-[#00A9CE] bg-[#E3F2FD] p-6">
          <p className="text-sm text-gray-700">
            <strong>Key Principle:</strong> Users should never need to understand Hedera, wallets,
            or HBAR. The system handles all blockchain complexity behind the scenes.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="mt-4 text-gray-700">
          When a user (patient, hospital, or researcher) registers with MediPact, a Hedera account
          is automatically created for them. The platform:
        </p>
        ...
        <p className="mt-4 text-gray-700">
          Users can view their Hedera Account ID and EVM Address in their wallet page, but they
          never need to interact with these directly.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-4 text-gray-700">
          All balances are displayed with USD as the primary currency, making it easy for users to
        ...
        <div className="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-6">
          <div className="space-y-2">
            ...
            <div className="mt-4 text-xs text-gray-500">Hedera Account: 0.0.1234567</div>
          </div>
        </div>
        <p className="mt-4 text-sm text-gray-600">
          Exchange rates are fetched dynamically from CoinGecko API and cached for 5 minutes to
          ensure accurate USD conversions.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
          <p className="text-sm text-gray-700">
            <strong>Security:</strong> All payment account numbers and mobile money numbers are
            encrypted using AES-256-GCM before storage. They are only decrypted when needed for
    ...
    Platform->>Platform: Update User Records`}
        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Users can initiate withdrawals at any time from their wallet page. They specify the
              amount in USD, and the system handles the HBAR conversion automatically.
            </p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            <h3 className="font-semibold">Automatic Withdrawal</h3>
            <p className="mt-2 text-sm text-gray-600">
              Users can enable automatic withdrawals with a threshold (e.g., $10 for patients, $100
              for hospitals). When the balance reaches the threshold, a withdrawal is automatically
              initiated. Users receive a notification when the threshold is reached.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="flex items-start gap-3 rounded-lg border border-gray-200 bg-white p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Withdrawal could not be processed. Funds remain in wallet. System will automatically
      ...
      <section>
        ...
        <ul className="mt-4 list-disc space-y-2 pl-6 text-gray-700">
          <li>
            <strong>Exponential Backoff:</strong> Failed withdrawals are retried with increasing
            delays (5s, 10s, 20s, up to 60s max)
          </li>
          <li>
            <strong>Maximum Retries:</strong> Up to 3 automatic retries before marking as failed
          </li>
          <li>
            <strong>Admin Retry:</strong> Admins can manually retry failed withdrawals from the
            admin dashboard
          </li>
          <li>
            <strong>Non-Critical Notifications:</strong> Notification failures don't block
            withdrawals
          </li>
          <li>
            <strong>Transaction Logging:</strong> All withdrawal attempts are logged for audit
            purposes
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="mt-4 text-sm text-gray-600">
          <strong>Important:</strong> The hospital from which the data was originally collected
          remains the sole beneficiary of that data's revenue, ensuring fair compensation for data
          collection efforts.
        </p>
      </section>
...
Body: {
  ...
  "autoWithdrawEnabled": true
      ...
      <section>
        ...
        <div className="mt-4 space-y-3">
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Bank account numbers and mobile money numbers are encrypted using AES-256-GCM before
              storage. Keys are managed securely and never exposed.
            </p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            <h3 className="font-semibold">Private Key Management</h3>
            <p className="mt-2 text-sm text-gray-600">
              Hedera private keys are encrypted and stored securely. Users never need to manage or
              see their private keys.
            </p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            <h3 className="font-semibold">Access Control</h3>
            <p className="mt-2 text-sm text-gray-600">
              Users can only access their own wallet information. All API endpoints are protected
      ...
      <section>
        ...
        <p className="mt-4 text-gray-700">Planned improvements to the payment system:</p>
        <ul className="mt-4 list-disc space-y-2 pl-6 text-gray-700">
          <li>
            Integration with payment gateways (Flutterwave, Paystack) for automated bank and mobile
            money transfers
          </li>
