...
export default function DoubleAnonymizationPage() {
  return (
    <div className="space-y-6 sm:space-y-8">
      <div className="border-b border-gray-200 pb-4 sm:pb-6 md:pb-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Double Anonymization</h1>
      ...
      <section>
        ...
        <div className="mt-3 sm:mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Stage 1: Storage</h3>
          ...
          <div className="rounded-lg border border-purple-200 bg-purple-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Stage 2: Chain</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Why Double Anonymization?</h2>
        <div className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">Defense in Depth</h3>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">Different Purposes</h3>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">Provenance Tracking</h3>
            <p className="mt-1.5 sm:mt-2 text-sm sm:text-base text-gray-700">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">Compliance Ready</h3>
            <p className="mt-1.5 sm:mt-2 text-sm sm:text-base text-gray-700">
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Two-Stage Process</h2>
        <MermaidDiagram
          chart={`flowchart TD
    ...
    style N fill:#00A9CE,color:#fff,stroke:#007A99,stroke-width:3px`}
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Stage 1: Storage Anonymization</h2>
        <div className="mt-3 sm:mt-4 rounded-lg border border-blue-200 bg-blue-50 p-4 sm:p-5 md:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Purpose: Research-Optimized Privacy</h3>
          <p className="mt-2 text-gray-700">
        ...
        <div className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">What Gets Removed</h3>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">What Gets Preserved</h3>
            <ul className="mt-2 list-disc space-y-1 pl-6 text-gray-700">
              <li>
  ...
  "valueQuantity": "8.1"
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Stage 2: Chain Anonymization</h2>
        <div className="mt-3 sm:mt-4 rounded-lg border border-purple-200 bg-purple-50 p-4 sm:p-5 md:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Purpose: Maximum Blockchain Privacy</h3>
          <p className="mt-2 text-gray-700">
        ...
        <div className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">Additional Generalizations</h3>
            <ul className="mt-2 list-disc space-y-1 pl-6 text-gray-700">
              <li>
  ...
  "valueQuantity": "8.1"
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Provenance Records</h2>
        <div className="mt-3 sm:mt-4 rounded-lg border border-[#00A9CE] bg-[#E3F2FD] p-4 sm:p-5 md:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-[#00A9CE]">What is a Provenance Record?</h3>
          <p className="mt-2 text-gray-700">
        ...
        <div className="mt-3 sm:mt-4 rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Structure</h3>
          <CodeBlock
            code={`{
  "storage": {
    "hash": "abc123def456...",
  ...
  "provenanceProof": "xyz789abc123..."
        ...
        <div className="mt-3 sm:mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          <div className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Storage Hash (H1)</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
              SHA-256 hash of Stage 1 anonymized data. Used for backend storage verification.
            </p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Chain Hash (H2)</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
              SHA-256 hash of Stage 2 anonymized data. Used for immutable blockchain storage.
            </p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Provenance Proof</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Verification Process</h2>
        <p className="mt-3 sm:mt-4 text-sm sm:text-base text-gray-700">
          Anyone can verify the provenance chain on Hedera HashScan:
        </p>
        <div className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">1. Origin Verification</h3>
...
assert(provenanceRecord.chain.hash === expectedChainHash);`}
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">2. Transformation Verification</h3>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">3. Provenance Proof Verification</h3>
...
assert(provenanceRecord.provenanceProof === expectedProof);`}
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Comparison Table</h2>
          ...
          <div className="inline-block min-w-full align-middle">
            <table className="min-w-full divide-y divide-gray-200 border border-gray-200">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                <tr>
                  <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">Age Range</td>
                  <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">5-year (e.g., "35-39")</td>
                  <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">10-year (e.g., "30-39")</td>
                </tr>
              <tr>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">Dates</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Exact (YYYY-MM-DD)</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Month/Year (YYYY-MM)</td>
              </tr>
              <tr>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">Location</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Country + Region + District</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Country only</td>
              </tr>
              <tr>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">Occupation</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Specific category</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Broad category</td>
              </tr>
              <tr>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">Purpose</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Research queries</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Blockchain storage</td>
              </tr>
              <tr>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">Privacy Level</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">High</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Maximum</td>
              </tr>
              <tr>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900">Data Utility</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">High (preserves detail)</td>
                <td className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-600">Medium (generalized)</td>
              </tr>
            </tbody>
          </table>
          </div>
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Benefits</h2>
        <div className="mt-3 sm:mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div className="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Double Protection</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
              Two layers of anonymization ensure maximum privacy protection with defense in depth.
            </p>
          </div>
          <div className="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Provenance Chain</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
              Verifiable transformation chain on Hedera allows anyone to verify origin and transformation.
            </p>
          </div>
          <div className="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Origin Proof</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
              Both hashes prove same source, providing complete audit trail for compliance.
            </p>
          </div>
          <div className="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Transformation Proof</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
              Chain hash derived from storage hash is verifiable, proving the transformation chain.
            </p>
          </div>
          <div className="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Public Verification</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
              Anyone can verify provenance records on HashScan, ensuring transparency and trust.
            </p>
          </div>
          <div className="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">Compliance Ready</h3>
            <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600">
      ...
      <section>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">HashScan Verification</h2>
        <div className="mt-3 sm:mt-4 rounded-lg border border-gray-200 bg-white p-4 sm:p-5 md:p-6">
