...
export default function DoubleAnonymizationPage() {
    ...
    <div className="space-y-8">
      <div className="border-b border-gray-200 pb-8">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Two-stage anonymization with provenance tracking for maximum privacy protection and
      ...
      <section>
        ...
        <p className="mt-4 text-gray-700">
          MediPact implements <strong>double anonymization</strong> with provenance tracking to
          provide maximum privacy protection and verifiable data transformation on the Hedera
          blockchain. This two-stage approach ensures defense in depth while maintaining data
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Optimized for research queries while protecting privacy. Preserves 5-year age ranges
              and exact dates.
            </p>
          </div>
          <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Maximum privacy for immutable blockchain storage. Further generalizes to 10-year
              ranges and month/year dates.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="mt-2 text-gray-700">
              Two layers of protection ensure that if one layer fails, the other still protects
              patient privacy. Different anonymization strategies at each stage provide
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="mt-2 text-gray-700">
              Storage anonymization is optimized for research queries (preserves detail), while
              chain anonymization is optimized for privacy on immutable blockchain storage (maximum
              generalization).
            </p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="mt-2 text-gray-700">
              Both hashes stored together on Hedera with a provenance proof allows anyone to verify
              that the chain hash was derived from the storage hash, providing complete audit trail
              and transformation verification.
            </p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            <h3 className="text-lg font-semibold text-gray-900">Compliance Ready</h3>
            <p className="mt-2 text-gray-700">
              Meets strict regulatory requirements including GDPR and HIPAA. Demonstrates layered
              privacy protection and exceeds Safe Harbor de-identification standards.
            </p>
          </div>
        </div>
      </section>
    ...
    style N fill:#00A9CE,color:#fff,stroke:#007A99,stroke-width:3px`}
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-blue-200 bg-blue-50 p-6">
          ...
          <p className="mt-2 text-gray-700">
            Stage 1 anonymization is designed to protect privacy while preserving data utility for
            research queries.
          </p>
        </div>
        <div className="mt-4 space-y-4">
  ...
  "valueQuantity": "8.1"
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-purple-200 bg-purple-50 p-6">
          ...
          <p className="mt-2 text-gray-700">
            Stage 2 anonymization applies further generalization specifically for immutable
            blockchain storage where data cannot be deleted or modified.
          </p>
        </div>
        <div className="mt-4 space-y-4">
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-6 text-gray-700">
              ...
              <li>
                <strong>Occupation:</strong> Further generalize (e.g., "Healthcare Worker" →
                "Healthcare")
              </li>
              <li>
  ...
  "valueQuantity": "8.1"
            ...
            <p className="mt-4 text-sm text-gray-600">
              <strong>Note:</strong> Region/district removed, age range expanded, date rounded to
              month, occupation generalized.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-[#00A9CE] bg-[#E3F2FD] p-6">
          ...
          <p className="mt-2 text-gray-700">
            A provenance record contains both hashes (storage + chain) with a cryptographic proof
            linking them together, stored immutably on Hedera HCS.
          </p>
        </div>
      ...
      <section>
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="rounded-lg border border-green-200 bg-green-50 p-4">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Verifiable transformation chain on Hedera allows anyone to verify origin and
              transformation.
            </p>
          </div>
          <div className="rounded-lg border border-green-200 bg-green-50 p-4">
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-gray-200 bg-white p-6">
          ...
          <ol className="mt-4 list-decimal space-y-2 pl-6 text-gray-700">
            ...
            <li>
              Verify <code className="rounded bg-gray-100 px-1 py-0.5">derivedFrom</code> link
            </li>
